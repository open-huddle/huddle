...
func (_q *NotificationQuery) QueryRecipient() *UserQuery {
...
func (_q *NotificationQuery) QueryMessage() *MessageQuery {
...
func (_q *NotificationQuery) QueryChannel() *ChannelQuery {
...
func (_q *NotificationQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *NotificationQuery) WithRecipient(opts ...func(*UserQuery)) *NotificationQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *NotificationQuery) WithMessage(opts ...func(*MessageQuery)) *NotificationQuery {
	query := (&MessageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NotificationQuery) WithChannel(opts ...func(*ChannelQuery)) *NotificationQuery {
	query := (&ChannelClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NotificationQuery) WithOrganization(opts ...func(*OrganizationQuery)) *NotificationQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NotificationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Notification, error) {
	...
	if query := _q.withChannel; query != nil {
		if err := _q.loadChannel(ctx, query, nodes, nil,
			func(n *Notification, e *Channel) { n.Edges.Channel = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrganization; query != nil {
		if err := _q.loadOrganization(ctx, query, nodes, nil,
			func(n *Notification, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *NotificationQuery) loadRecipient(ctx context.Context, query *UserQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *User)) error {
...
func (_q *NotificationQuery) loadMessage(ctx context.Context, query *MessageQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Message)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Notification)
	for i := range nodes {
...
func (_q *NotificationQuery) loadChannel(ctx context.Context, query *ChannelQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Channel)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Notification)
	for i := range nodes {
...
func (_q *NotificationQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Organization)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Notification)
	for i := range nodes {
...
func (_q *NotificationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withRecipient != nil {
			_spec.Node.AddColumnOnce(notification.FieldRecipientUserID)
		}
		if _q.withMessage != nil {
			_spec.Node.AddColumnOnce(notification.FieldMessageID)
		}
		if _q.withChannel != nil {
			_spec.Node.AddColumnOnce(notification.FieldChannelID)
		}
		if _q.withOrganization != nil {
			_spec.Node.AddColumnOnce(notification.FieldOrganizationID)
		}
	}
