...
const (
	...
	IdentityServiceName = "huddle.v1.IdentityService"
)
...
const (
	...
	IdentityServiceWhoAmIProcedure = "/huddle.v1.IdentityService/WhoAmI"
)

// IdentityServiceClient is a client for the huddle.v1.IdentityService service.
...
// NewIdentityServiceClient constructs a client for the huddle.v1.IdentityService service. By
...
func NewIdentityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IdentityServiceClient {
	...
	identityServiceMethods := v1.File_huddle_v1_identity_proto.Services().ByName("IdentityService").Methods()
...
// WhoAmI calls huddle.v1.IdentityService.WhoAmI.
...
// IdentityServiceHandler is an implementation of the huddle.v1.IdentityService service.
...
func NewIdentityServiceHandler(svc IdentityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/huddle.v1.IdentityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIdentityServiceHandler) WhoAmI(context.Context, *connect.Request[v1.WhoAmIRequest]) (*connect.Response[v1.WhoAmIResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("huddle.v1.IdentityService.WhoAmI is not implemented"))
}
